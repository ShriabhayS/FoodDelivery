...
class EKF:
    ...
    def predict(self, raw_drive_meas):
        ...
        self.set_state_vector(self.get_state_vector()) # Just in case, this drive was giving us errors when testing
    ...
    def update(self, measurements):
        ...
        x_new = x + K @ Y                            #getting new state
        #print(x_new)
        self.set_state_vector(x_new)                 #updating state
        self.P = (np.eye(len(K)) - K @ H) @ self.P   #updating covariance
